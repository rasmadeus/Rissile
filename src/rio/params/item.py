...
class Item:
    ...
    def flags(self, column):
        ...
        """
        if column == 0: return QtCore.Qt.ItemIsSelectable | QtCore.Qt.ItemIsEnabled
        return self._flags_for_value()


    def _flags_for_value(self):
        """
        :return: флаги, позволяющие редактировать величину.
        """
